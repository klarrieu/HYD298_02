...
class MU:
    ...
    def mu_maker(self, h_raster, u_raster, full_out_ras_name, full_out_shp_name, *mu):
        ...
        arcpy.RasterToPolygon_conversion(arcpy.Raster(full_out_ras_name), temporary_shp, 'NO_SIMPLIFY')
        ...
        arcpy.AddField_management(full_out_shp_name, "MorphUnit", "TEXT", field_length=50)
    ...
    def __call__(self, *args, **kwargs):
        print("Class Info: <type> = cMorphologicalUnits.MU")
